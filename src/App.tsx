  ...
  return (
    <div className="w-full h-screen bg-gray-900 relative overflow-hidden">
          ...
          <div className="flex items-center space-x-3">
            ...
            {!vrSupported && (
              <div className="flex items-center space-x-2 text-amber-400 bg-amber-900/20 px-3 py-2 rounded-lg">
                ...
                <span className="text-sm">WebXR pas supporté</span>
              </div>
            )}
            ...
            {vrSupported && (
              ...
              >
                {vrActive ? "Sortir de la VR" : "Entrer en VR"}
              </button>
            )}
          </div>
        </div>
      ...
      <div className="flex h-full pt-16">
        ...
        <div
          className={`bg-gray-800/50 backdrop-blur border-r border-gray-700 flex flex-col transition-all duration-300 ${
      ...
      {vrActive && (
        <div className="absolute bottom-6 left-1/2 transform -translate-x-1/2 z-20">
          <div className="bg-black/80 backdrop-blur rounded-lg px-6 py-3 text-white text-center">
            <p className="text-sm">
              <span className="font-medium">Mouvements:</span> Utilisez le
              joystick gauche pour vous déplacer
              <span className="mx-2">•</span>
              <span className="font-medium">Intéractions:</span> Pointez et
              cliquez avec le contrôleur ou utilisez les mains (lynx R1) pour
      ...
      {!isFullscreen && (
        <div className="absolute bottom-4 right-4 z-20">
          <div className="bg-blue-900/20 border border-blue-500/30 rounded-lg px-3 py-2 text-blue-400 text-sm">
            Cliquez n'importe ou pour entrer en plein écran
          </div>
        </div>
      )}
    </div>
